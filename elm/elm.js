...
Elm.CounterNik = Elm.CounterNik || {};
Elm.CounterNik.make = function (_elm) {
   "use strict";
   _elm.CounterNik = _elm.CounterNik || {};
   if (_elm.CounterNik.values)
   return _elm.CounterNik.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "CounterNik",
   $Basics = Elm.Basics.make(_elm),
   ...
   model) {
      ...
      _L.fromArray([A2($Html.button,
                   ...
                   address,
                   Make100)]),
                   _L.fromArray([$Html.text("make100")]))]));
   });
   ...
   model) {
      return function () {
         ...
         {case "Decrement":
            ...
            case "Make100":
            return init(100);
            case "Reset": return init(0);}
         _U.badCase($moduleName,
         "between lines 19 and 23");
      }();
   });
   _elm.CounterNik.values = {_op: _op
                            ,init: init
                            ,Increment: Increment
                            ,Decrement: Decrement
                            ,Reset: Reset
...
Elm.Main.make = function (_elm) {
   ...
   $moduleName = "Main",
   $Basics = Elm.Basics.make(_elm),
   $CounterNik = Elm.CounterNik.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var main = $StartApp$Simple.start({_: {}
                                     ,model: 0
                                     ,update: $CounterNik.update
                                     ,view: $CounterNik.view});
